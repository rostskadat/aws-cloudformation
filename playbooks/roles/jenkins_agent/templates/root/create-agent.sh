...
cat /root/agent.xml | java -jar jenkins-cli.jar -s http://$masterIP:8080 -auth 'admin:{{JenkinsAdminPassword}}' create-node $(curl -s -m 60 http://169.254.169.254/latest/meta-data/instance-id)
